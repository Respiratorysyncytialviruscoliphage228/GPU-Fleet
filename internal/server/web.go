...
<body>
  ...
  <script>
    ...
    function projectPanel() {
      ...
      return '<article class="panel setting-operation project-card release-card" data-testid="settings-project"><div class="operation-head"><div class="operation-icon project-logo">' + logo + '</div><div><h2>版本与变更</h2><p>GPUFleet v0.1.0</p></div></div><div class="project-meta"><div><span>作者</span><strong>stlin256</strong></div><div><span>版本</span><strong>v0.1.0</strong></div><div><span>提交</span><strong>dev</strong></div><div><span>构建时间</span><strong>-</strong></div><div class="project-url"><span>仓库地址</span><a href="https://github.com/stlin256/GPU-Fleet" target="_blank" rel="noreferrer">https://github.com/stlin256/GPU-Fleet</a></div></div><div class="changelog-panel" data-testid="settings-changelog"><div class="changelog-head"><span>最近变更</span></div><div class="changelog-entry"><div><strong>v0.1.0</strong><span>2026-06-03</span></div><p>MVP 预览版：安全的多设备 GPU 可观测面板</p><div class="changelog-group"><span>新增</span><ul><li>支持 Windows 和 Linux NVIDIA GPU 设备的客户端-服务端架构。</li><li>多设备 GPU 卡片、历史图表、深浅主题和移动端底部导航。</li><li>首次启动交互式配置密码、端口和可选 HTTPS 证书。</li><li>设置页可查看版本号、构建信息和变更记录。</li></ul></div><div class="changelog-group"><span>安全</span><ul><li>Agent 上报使用 HMAC 签名和 nonce 重放保护。</li><li>Web 登录具备 30 天会话、防限流和递进锁定。</li></ul></div></div></div><a class="secondary action-button" href="https://github.com/stlin256/GPU-Fleet" target="_blank" rel="noreferrer">打开 GitHub</a></article>';
    }
