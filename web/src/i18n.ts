...
const en: Record<string, string> = {
  ...
  '登录中': 'Logging in',
  '登录': 'Log in',
  '密码不正确，请再试一次': 'The password is incorrect. Try again.',
  '登录尝试过于频繁，请稍后再试': 'Too many login attempts. Try again shortly.',
  '无法连接服务端，请检查网络后重试': 'Cannot reach the server. Check the network and try again.',
  '登录失败，请稍后再试': 'Login failed. Try again shortly.',
  ...
  '更新范围': 'Update scope',
  '更新源': 'Update source',
  '官方 GitHub Release': 'Official GitHub Release',
  '自定义签名源': 'Custom signed source',
  ...
  'Agent 自动更新已保存，将使用官方 GitHub Release': 'Agent auto update saved; official GitHub Release will be used',
  ...
  '诊断包导出': 'Diagnostics Export',
  '选择诊断包类型': 'Choose diagnostics package type',
  '标准包适合日常排障；高级包用于深入分析 Agent、采集、访客和进程状态。': 'The standard package is for routine troubleshooting; the advanced package is for deeper Agent, collection, guest, and process analysis.',
  '标准诊断包': 'Standard diagnostics',
  '高级诊断包': 'Advanced diagnostics',
  '包含版本、运行时、服务配置、磁盘、健康摘要、设备、GPU、指标窗口、进程数量、Agent 配置摘要、更新状态和最近审计摘要。': 'Includes version, runtime, service configuration, disk, health summary, devices, GPUs, metric windows, process counts, Agent configuration summaries, update status, and recent audit summaries.',
  '在标准包基础上增加完整 Agent 配置报告、脱敏进程快照、访客记录、Web 会话时间摘要和指标分段清单；仍不会导出密钥、Cookie、私钥或完整 IP。': 'Adds full Agent configuration reports, redacted process snapshots, guest records, web session timing summaries, and metric segment listings; secrets, cookies, private keys, and full IP addresses are still excluded.',
